...
CREATE TABLE `student_profile` (
  ...
  `guardians_first_name` varchar(255) NOT NULL,
  `guardians_last_name` varchar(255) NOT NULL,
  `guardians_email` varchar(255) NOT NULL,
  `guardians_phone_number` varchar(255) NOT NULL,
  ...
  UNIQUE KEY `guardians_email_UNIQUE` (`guardians_email`),
