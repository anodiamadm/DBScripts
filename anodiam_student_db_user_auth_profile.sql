...
CREATE TABLE `student_profile` (
  ...
  CONSTRAINT `FK_student_profile_id` FOREIGN KEY (`student_profile_id`) REFERENCES `mst_user` (`user_id`),
...
INSERT INTO `student_profile` (`student_profile_id`,`first_name`,`last_name`,`email`,`phone_number`,`guardians_email`,`guardians_phone_number`,
								`board_id`,`level_id`,`country_id`,`state_id`,`town_id`,`suburb_id`,`profile_image_link`) VALUES (
								1,'Dan','Nandan','dan@anodiam.com','+919748407166','baapdan@gmail.com','+1-5678912345',1,11,2,5,8,5,
									...
									(2,'Anirban','Chakrabarty','anirban@Anodiam.com','+61470142229',NULL,NULL,2,10,2,6,13,8,
