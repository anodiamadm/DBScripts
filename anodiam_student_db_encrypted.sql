...
/*
***** Need to insert Bcrypt encrypted values for country_code and country_name
...
/*
***** Need to insert Bcrypt encrypted values for state_code and state_name
...
/*
***** Need to insert Bcrypt encrypted values for town_name
...
/*
***** Need to insert Bcrypt encrypted values for zip_code and suburb_name
...
CREATE TABLE `mst_board` (
  ...
  `board_short_name` varchar(255) NOT NULL,
...
/*
***** Need to insert Bcrypt encrypted values for board_short_name and board_name
...
/*
***** Need to insert Bcrypt encrypted values for level_code and level_name
...
/*
***** Need to insert Bcrypt encrypted values for password, username and email (like already password field id encrypted)
INSERT INTO `mst_user` VALUES (1,1,'2021-09-02 12:18:20','$2a$14$gh4hfltUGwB315NieowSduN/jb6DQjBhMqsRx1YSS7YDNTrr8C/bC','dan','encrypted_email'),
								(2,1,'2021-09-02 12:18:22','$2a$14$VkFfuxZTTJzKc2B31PjHZeNwz.znGgUqh03UWY4fVDE0Fq7ffnc42','anirban','encrypted_email'),
								(3,1,'2021-09-02 12:18:24','$2a$14$qUEha8IlzRzCqu0M6XNmsOFW3O1Q2tggjg3nrvYXeiKXUMU51pTha','admin','encrypted_email'),
								(4,1,'2021-09-02 12:18:26','$2a$14$E16Hc0v6miF2wtZ22IXSUOHT1cSzWycCvnprgVJrPC3087XXJV7Vi','manager','encrypted_email'),
								(5,1,'2021-09-08 10:56:44','$2a$14$gh4hfltUGwB315NieowSduxn/JACaGJqdyclsSIjYmN95p596qgP6','Anoushka','encrypted_email');
*/
UNLOCK TABLES;
...
/*
***** Need to insert into mst_user table before inserting into user_permission table due to FK constraints
...
/*
***** Need to insert into mst_user table before inserting into user_role table due to FK constraints
...
/*
***** Need to insert into mst_board, mst_level, mst_suburb and mst_user tables before inserting into student_profile table due to FK constraints
***** Need to insert Bcrypt encrypted values for first_name, middle_name, last_name, phone_number, guardians_first_name,
  guardians_last_name, guardians_email, guardians_phone_number, profile_image_link
INSERT INTO `student_profile` (`student_profile_id`,`first_name`,`middle_name`,`last_name`,`phone_number`,`guardians_first_name`,`guardians_last_name`,
	`guardians_email`,`guardians_phone_number`,`board_id`,`level_id`,`suburb_id`,`profile_image_link`,`user_id`) VALUES (
		1,'Dan','Kumar','Nandan','+919748407166','Baap','Reddy','baapdan@gmail.com','+1-5678912345',1,11,5,
		'https://www.google.com', 1),
		(2,'Anirban',NULL,'Chakrabarty','+61470142229',NULL,NULL,NULL,NULL,2,10,8,
		'https://www.google.com', 2),
		(3,'Anoushka','','Rhuam','+61405706206',NULL,NULL,'anirban@anodiam.com','+61470142229',2,10,8,
